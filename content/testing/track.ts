...
import unitV3 from './unit/chapter.ts';
import integrationV3 from './integration/chapter.ts';
import reactTestingV3 from './react-testing/chapter.ts';
import strategy2V3 from './strategy-2/chapter.ts';
...
export default defineTrack({
  ...
  chapters: [discriminate, doubles, unitV3, integrationV3, reactTestingV3, strategy2V3],
});
